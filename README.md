...
The repository represents three different type of solutions for toggling visibility 👀 in a React app. There are examples 📘 with functional, class based and styled components.
